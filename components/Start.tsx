          ...
          <div className="row">
            ...
            <div className="statistics__wrapper">
              <div className="statistics__content--header">
                ...
                <div
                  className={`statistics__heading ${
                    index === 1 && `statistics__heading--active`
                  }`}
                >
                ...
                <div
                  className={`statistics__heading ${
                    index === 2 && `statistics__heading--active`
                  }`}
                >
                  Improve your health
                </div>
                <div
                  className={`statistics__heading ${
                    index === 3 && `statistics__heading--active`
                  }`}
                >
                ...
                <div
                  className={`statistics__heading ${
                    index === 4 && `statistics__heading--active`
                  }`}
                >
                  Increase happiness
                </div>
                <div
                  className={`statistics__heading ${
                    index === 5 && `statistics__heading--active`
                  }`}
                >
