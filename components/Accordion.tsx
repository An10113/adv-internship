      ...
      <div className="faq__wrapper">
              <div className="accordion__card" onClick={() => handleTabChange(1)}>
                <div className="accordion__header">
                  ...
                  <div className={tab === 1 ? "accordion__icon--rotate": ""}>
                  <BsChevronDown size={24}/>
                  </div>
                </div>
                <div className={tab !== 1 ? " h-0 overflow-hidden" : "h-auto"} >
              ...
              <div className="accordion__card" onClick={() => handleTabChange(2)}>
                <div className="accordion__header">
                  ...
                  <div className={tab === 2 ? "accordion__icon--rotate": ""}>
                  <BsChevronDown size={24}/>
                  </div>
                </div>
                <div className={ tab !== 2 ? " h-0 overflow-hidden" : "h-auto"}>
                  <div className="accordion__body">
              ...
              <div className="accordion__card" onClick={() => handleTabChange(3)}>
                <div className="accordion__header">
                  ...
                  <div className={tab === 3 ? "accordion__icon--rotate": ""}>
                  <BsChevronDown size={24}/>
                  </div>
                </div>
                <div className={tab !== 3 ? " h-0 overflow-hidden" : "h-auto"} >
                  <div className="accordion__body">
              ...
              <div className="accordion__card" onClick={() => handleTabChange(4)}>
                <div className="accordion__header">
                  ...
                  <div className={tab === 4 ? "accordion__icon--rotate": ""}>
                  <BsChevronDown size={24}/>
                  </div>
                </div>
                <div className={tab !== 4 ? " h-0 overflow-hidden" : "h-auto"}>
                  <div className="accordion__body">
